...
dxc -T vs_6_0 -E main -Fo "%DX_OUTPUT_DIR%\vs_rainbow.cso" DirectX12\Shaders\vs_rainbow.hlsl
dxc -T ps_6_0 -E main -Fo "%DX_OUTPUT_DIR%\ps_rainbow.cso" DirectX12\Shaders\ps_rainbow.hlsl
...
dxc -T vs_6_0 -E main -Fo "%DX_OUTPUT_DIR%\vs_lighting.cso" DirectX12\Shaders\vs_lighting.hlsl
dxc -T ps_6_0 -E main -Fo "%DX_OUTPUT_DIR%\ps_lighting.cso" DirectX12\Shaders\ps_lighting.hlsl
